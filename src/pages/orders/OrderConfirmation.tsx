      ...
      <div className="bg-gradient-to-b from-green-50 to-white min-h-screen py-12">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Thank you for your order. We'll deliver fresh seafood to your door.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mb-6">
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2 text-gray-600">
                ...
                <p><strong>Delivery Date:</strong> {new Date(order.deliveryDetails.deliveryDate).toLocaleDateString()}</p>
                <p><strong>Time Slot:</strong> {order.deliveryDetails.deliveryTime}</p>
              </div>
            </div>
            ...
            <div className="mt-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-white border-2 border-yellow-400 rounded-lg p-4 mb-4">
                        ...
                        <p className="text-3xl font-bold text-yellow-900">₹{order.totalAmount.toFixed(2)}</p>
                      ...
                      <div className="mt-4 p-3 bg-yellow-100 rounded border border-yellow-300">
                        <p className="text-xs font-semibold text-yellow-800 mb-1">📋 Payment Instructions:</p>
                        <ol className="text-xs text-yellow-700 space-y-1 list-decimal list-inside">
                          <li>Click the button above to open Razorpay</li>
                          <li>Enter amount: <strong>₹{order.totalAmount.toFixed(2)}</strong></li>
              ...
              {order.payment?.method === 'razorpay-link' && order.payment?.status === 'completed' && (
              ...
              {order.payment?.method === 'whatsapp' && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                  <div className="flex items-start">
                    <svg className="w-6 h-6 text-green-600 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-green-700 mb-3">
                        Your order has been sent via WhatsApp. Please complete payment to confirm your order.
                      </p>
                      ...
                      <div className="bg-white border-2 border-green-300 rounded-lg p-3 mb-3">
                        ...
                        <p className="text-2xl font-bold text-green-900">₹{order.totalAmount.toFixed(2)}</p>
                      </div>

                      {/* Payment Instructions */}
                      <div className="bg-green-100 rounded-lg p-3 border border-green-300">
                        <p className="text-xs font-semibold text-green-800 mb-2">📱 Payment Methods:</p>
                        <div className="space-y-1 text-xs text-green-700">
                          <p>• UPI: Send to <strong>9994072395@paytm</strong></p>
                          <p>• PhonePe / Google Pay: <strong>9994072395</strong></p>
