                ...
                >
                  ...
                  <div className="mb-4">
                    <p className="text-sm text-gray-600">
                      {order.items.length} item{order.items.length !== 1 ? 's' : ''} • Delivery: {new Date(order.deliveryDetails.deliveryDate).toLocaleDateString()} {order.deliveryDetails.deliveryTime}
                    </p>
                  </div>
