  ...
  const runTests = async () => {
    ...
    addResult(
      ...
      storedUser && storedToken
        ...
        : 'Missing auth data in localStorage',
      {
        hasUser: !!storedUser,
        ...
        <div className='max-w-4xl mx-auto'>
          <div className='mb-8'>
            ...
            <p className='text-gray-600'>
              Diagnose admin API connection issues
            </p>
          </div>
            ...
            <Card>
              ...
              <div className='mt-6 p-4 bg-blue-50 rounded-md'>
                ...
                <ul className='text-sm text-blue-800 space-y-1 list-disc list-inside'>
                  {results.some(
                    (r) => r.status === 'error' && r.test === 'Authentication'
                  ) && <li>You need to log in first</li>}
                  {results.some(
                    (r) => r.status === 'error' && r.test === 'Admin Role'
                  ) && (
                    <li>
                  ...
                  {results.some(
                    ...
                    <>
                      ...
                      <li>
                        Verify CORS is enabled in backend for
                        http://localhost:5173
                      </li>
                    </>
                  )}
